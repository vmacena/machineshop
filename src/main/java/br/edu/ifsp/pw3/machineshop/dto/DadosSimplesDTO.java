...
public record DadosSimplesDTO(String dataDeEntrada, String dataDeSaida, String nomeMecanico,
                              String marcaVeiculo, String modeloVeiculo) {

    public DadosSimplesDTO(Conserto conserto) {
        this(conserto.getDataDeEntrada(), conserto.getDataDeSaida(), conserto.getMecanico().getNome(),
